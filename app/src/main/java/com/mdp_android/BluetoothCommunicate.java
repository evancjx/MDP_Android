...
public class BluetoothCommunicate {
    ...
    private static final String NAME_SECURE = "btSecure", NAME_INSECURE = "btInsecure";
     ...
     */
    public BluetoothCommunicate(Context context, Handler handler) {
    ...
    private void connectionFailed() {
        ...
        Bundle bundle = new Bundle();
        bundle.putString("toast", "Listening for device ...");
        msg.setData(bundle);
        mHandler.sendMessage(msg);

        // Start the service over to restart listening mode
        BluetoothCommunicate.this.start();
    }
    ...
    private class AcceptThread extends Thread {
        ...
        public void run() {
            ...
            while (mState != STATE_CONNECTED) {
                ...
                if (socket != null) {
                    synchronized (BluetoothCommunicate.this) {
                        switch (mState) {
                            case STATE_LISTEN:
    ...
    private class ConnectThread extends Thread {
        ...
        public void run() {
            ...
            // Always cancel discovery because it will slow reverse a connection
